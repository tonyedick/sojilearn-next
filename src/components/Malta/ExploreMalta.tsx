                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-1">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={capital} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-2">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={population} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-3">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={language} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-4">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={students} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-10">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={gdp} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6">
                        <div className="edu_cat_2 cat-6">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={dialing} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6">
                        <div className="edu_cat_2 cat-8">
                            <div className="edu_cat_icons">
                                <Link className="pic-main" href="/"><Image src={currency} className="img-fluid" alt="Explore malta currency, dialing code, gdp, international students, language, capital, population" /></Link>
                            </div>
                            <div className="edu_cat_data">
