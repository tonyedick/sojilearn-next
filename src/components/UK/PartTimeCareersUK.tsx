                        ...
                        <div className="mb-4 mt-4 ml-lg-0 mr-lg-4">
                            <div className="row mt-3">
                                <div className="col-lg-6 col-mg-6 col-sm-6">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={arts} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={socialsciences} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                            ...
                            <div className="row mt-3">
                                <div className="col-lg-6 col-mg-6 col-sm-6">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={law} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={engineering} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                            ...
                            <div className="row mt-3">
                                <div className="col-lg-6 col-mg-6 col-sm-6">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={architecture} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={design} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                            ...
                            <div className="row mt-3">
                                <div className="col-lg-6 col-mg-6 col-sm-6">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={medicine} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
                                ...
                                <div className="col-lg-6 col-mg-6 col-sm-6 mt-1">
                                    <div className="d-flex align-items-center">
                                        <div className="list_crs_img">
                                            <Image src={naturalsciences} height="50" width="50" className="img-fluid" alt="UK post graduate courses" />
                                        </div>
