...
import colimg from "../../assets/img/uk.jpg";
            ...
            <div className="row align-items-center justify-content-between mt-5">
                <div className="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                    <div className="side_block extream_img">
                        <Image src={colimg} className="img-fluid rounded" alt="Study in UK" loading="lazy" />
                    </div>
                </div>
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-3">
                    ...
                    <div className="inline_btn">
                        <Link href="/study-in-uk" className="btn-apply btn theme-bg text-white">View More</Link>
                    </div>
                </div>
            </div>
