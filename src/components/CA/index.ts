export { default as CANews } from './CANews';
export { default as BannerStudyInCanada } from './BannerStudyInCanada';
export { default as CTACA } from './CTACA';
export { default as ExploreCanada } from './ExploreCanada';
