                    ...
                    <div className="mb-4 mt-4 ml-lg-0 mr-lg-4">
                        <div className="d-flex align-items-center">
                            <div className="list_crs_img">
                                <Image src={cost} className="img-fluid" alt="Cost of living in Germany" loading="lazy"/>
                                <p>Low 
                    ...
                    <div className="mb-4 mt-4 ml-lg-0 mr-lg-4">
                        <div className="row mt-4">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <Image src={rent} height="50" width="50" className="img-fluid" alt="House rent in Germany" loading="lazy"/>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <Image src={food} height="50" width="50" className="img-fluid" alt="Cost of feeding in Germany" loading="lazy"/>
                        ...
                        <div className="row mt-4">
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <Image src={transport} height="50" width="50" className="img-fluid" alt="Cost of transport in Germany" loading="lazy"/>
                            ...
                            <div className="col-lg-6 col-mg-6 col-sm-6">
                                <div className="d-flex align-items-center">
                                    <div className="list_crs_img">
                                        <Image src={misc} height="50" width="50" className="img-fluid" alt="Cost of living in Germany" loading="lazy"/>
